...
console.log(props)
  ...
  <div className="mb-3 xl:w-96" style={{paddingLeft:"850px"}}>
    <div className="input-group relative flex  items-stretch w-full mb-4">
      ...
      <button className="card-img-top rounded-lg" style={{width:"150px",height:"40px",backgroundColor:"green",fontSize:"20px",color:"white"}}>Login</button>
    </div>
