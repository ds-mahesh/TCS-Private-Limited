...
export const getHeadConfig: GetHeadConfig<TemplateRenderProps> = ({
  ...
  return {
    title: `${document.c_meta_title?document.c_meta_title:`Domino's Pizza Stores in ${document.name} | Find a Local Store`}`,
    charset: "UTF-8",
    ...
    tags: [
      {
      ...
      },
        {
          ...
          attributes: {
            name: "description",
            content:`${document.c_meta_description?document.c_meta_description:`Use this page to find your nearest Domino's Pizza store in ${document.name} and discover the location details you need to visit us today.`}`,
          },
        },
...

      {
        ...
        attributes: {
          ...
          content: `${document.c_meta_description?document.c_meta_description:`Find Domino's Pizza Store ${document.name}. We stock high-quality, robust products at competitive rates.`}`
        },
      },
    ],
  };
